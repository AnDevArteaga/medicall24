    ...
    >
      ...
      >
        ...
        <p className="text-gray-700 text-left">
          Código promocional inválido, verifica que lo ingresaste correctamente.
          Si lo hiciste bien, puede que el código haya expirado.
        </p>
        <p className="text-gray-700 text-left mt-6">
          Pero no te preocupes, aún puedes acceder al descuento. Comunícate con
          la persona que te lo proporcionó para que te genere uno nuevo.
        </p>
        <button
