          ...
          <h1 className="text-gray-600 sm:hidden sm:text-center text-5xl md:text-4xl font-bold mb-8 animate-fade-in">
            ...
            <div className="w-full flex flex-col justify-start items-start sm:items-center sm:justify-center">
              <div className="mb-3">
                ...
                <p className="text-3xl sm:text-3xl font-semibold text-pink-600 sm:text-center">
              ...
              <div className="flex items-center space-x-2 mb-2 sm:mb-1">
                ...
                <span className="text-orange-500 text-xl font-bold">COP</span>
              </div>
              ...
              <CheckCircle className="w-4 h-4 text-pink-600 mr-3 flex-shrink-0" />
              ...
              <button
                className="bg-pink-600 w-auto text-white px-6 sm:px-3 py-3 rounded-xl text-lg sm:text-sm font-semibold hover:bg-pink-700 transition-colors shadow-md hover:shadow-lg mt-2 mb-4 md:text-3xl"
                onClick={openModal}
              >
                Consultar escala de precios de este plan
              </button>
