        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-8 relative overflow-hidden">
          ...
          <div className="text-center space-y-4 relative">
            ...
            <p className="text-lg text-gray-600 max-w-xl mx-auto">
              En estos momentos no puedes ingresar aquí. Por favor, verifica el producto que deseas adquirir.
            </p>
          </div>

          {/* Info Cards */}
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-gray-50 rounded-xl p-4 flex items-start space-x-4 transition-all duration-300 hover:shadow-md">
              <Package className="w-6 h-6 text-pink-600 mt-1" />
              <div>
                <h3 className="font-semibold text-gray-900">Revisa el Producto</h3>
                <p className="text-sm text-gray-600">Asegúrate de seleccionar correctamente el producto que deseas comprar</p>
              </div>
            </div>
          </div>
